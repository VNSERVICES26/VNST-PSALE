// script.js – Final version with Web3Modal, MetaMask, WalletConnect
...
const providerOptions = {
  walletconnect: {
    ...
    options: {
      infuraId: "d82c3569345e409d8dfdf54aada4c899" // ✅ Your Infura ID here
    }
  }
};
...
async function buyVNST() {
  ...
  // Step 1: Approve USDT
  const approveTx = await usdtContract.approve(swapAddress, usdtAmount);
