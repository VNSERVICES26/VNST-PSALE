...
const contractAddress = "0x20bD36676BF5Cbf2c12E82cA48F86882Cf034712";
...
async function initDApp() {
    // Check if mobile and no provider
    if (isMobile() && !window.ethereum && !window.BinanceChain) {
        showStatusMessage("Please open in Trust Wallet or MetaMask browser", "error");
        return;
    }
